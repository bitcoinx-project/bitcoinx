...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "searchexecrecord", 0, "fromBlock"},
    { "searchexecrecord", 1, "toBlock"},
    { "searchexecrecord", 2, "address"},
    { "searchexecrecord", 3, "topics"},
    { "waitforexecrecord", 0, "fromBlock"},
    { "waitforexecrecord", 1, "txlimit"},
    { "waitforexecrecord", 2, "address"},
    { "waitforexecrecord", 3, "topics"},
