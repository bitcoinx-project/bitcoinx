...
<context>
    ...
    <message>
        <source>%1 will download and store a copy of the BitcoinX block chain. At least %2GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.</source>
        <translation>%1 會下載並儲存一份 BitcoinX 區塊鏈的拷貝。至少有 %2GB 的資料會儲存到這個目錄中，並且還會持續增長。另外錢包資料也會儲存在這個目錄。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>A message that was attached to the bitcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the BitcoinX network.</source>
