#ifndef BITCOINX_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define BITCOINX_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // BITCOINX_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
