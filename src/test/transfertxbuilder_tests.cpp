...
BOOST_AUTO_TEST_CASE(transfertxbuilderbehavior_tests)
{
    ...
    txs.clear();
    txs.push_back(TestContractHelper::CreateEthTx(8000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), sCodes[6], addresses[0], hashTemp));
    result = TestContractHelper::Execute(txs);
    balances = {5000*SATOSHI_2_WEI_RATE, 2500*SATOSHI_2_WEI_RATE, 500*SATOSHI_2_WEI_RATE};
    checkRes(result.second, addresses, balances, 1);
    checkTx(result.second.transferTxs[0], 1, 3, {2500,5000,500});

    txs.clear();
    txs.push_back(TestContractHelper::CreateEthTx(2000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), sCodes[7], addresses[0], hashTemp));
    txs.push_back(TestContractHelper::CreateEthTx(2000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), sCodes[8], addresses[0], hashTemp));
    result = TestContractHelper::Execute(txs);
    balances = {0, 11500*SATOSHI_2_WEI_RATE, 500*SATOSHI_2_WEI_RATE};
    ...
    txs.clear();
    txs.push_back(TestContractHelper::CreateEthTx(2000*SATOSHI_2_WEI_RATE, dev::u256(30000), dev::u256(1), sCodes[6], addresses[1], hashTemp));
    txs.push_back(TestContractHelper::CreateEthTx(0, dev::u256(500000), dev::u256(1), sCodes[9], addresses[1], hashTemp));
    result = TestContractHelper::Execute(txs);
    balances = {0, 0, 0};
    checkRes(result.second, addresses, balances, 2);
    checkTx(result.second.transferTxs[0], 1, 1, {2000*SATOSHI_2_WEI_RATE});
...
BOOST_AUTO_TEST_CASE(transfertxbuilderbreadthways_tests)
{
    ...
    txs.clear();
    txs.push_back(TestContractHelper::CreateEthTx(15000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), sCodes[0], addresses[3], hashTemp));
    txs.push_back(TestContractHelper::CreateEthTx(0, dev::u256(500000), dev::u256(1), sCodes[11], addresses[3], hashTemp));

    result = TestContractHelper::Execute(txs);
    std::vector<dev::u256> balances = {5000*SATOSHI_2_WEI_RATE, 5000*SATOSHI_2_WEI_RATE, 5000*SATOSHI_2_WEI_RATE, 0};
...
BOOST_AUTO_TEST_CASE(transfertxbuilderdeep_tests)
{
    ...
    auto result = TestContractHelper::Execute(txs);
    txs.clear();
    txs.push_back(TestContractHelper::CreateEthTx(20000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), sCodes[11], addresses[4], hashTemp));
    result = TestContractHelper::Execute(txs);
    std::vector<dev::u256> balances = {1250*SATOSHI_2_WEI_RATE, 1250*SATOSHI_2_WEI_RATE, 2500*SATOSHI_2_WEI_RATE, 5000*SATOSHI_2_WEI_RATE, 10000*SATOSHI_2_WEI_RATE};
    checkRes(result.second, addresses, balances, 1);
...
BOOST_AUTO_TEST_CASE(transfertxbuildersuicide_tests)
{
    ...
    txs.push_back(TestContractHelper::CreateEthTx(13000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), valtype(), ContractUtil::CreateContractAddr(hashTemp, 1), hashTemp, 1));
    ...
    result = TestContractHelper::Execute(txs);
    std::vector<dev::u256> balances = {13000*SATOSHI_2_WEI_RATE, 0};
    checkRes(result.second, addresses, balances, 1);
...
BOOST_AUTO_TEST_CASE(transfertxbuilderpaytopubkeyhash_tests)
{
    ...
    txs.push_back(TestContractHelper::CreateEthTx(13000*SATOSHI_2_WEI_RATE, dev::u256(500000), dev::u256(1), valtype(), ContractUtil::CreateContractAddr(hashTemp, 13), hashTemp, 13));
    ...
    result = TestContractHelper::Execute(txs);
    std::vector<dev::u256> balances = {6500*SATOSHI_2_WEI_RATE, 6500*SATOSHI_2_WEI_RATE};
    checkRes(result.second, addresses, balances, 1);
